import { Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Popover, TextField, Typography } from '@mui/material';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import React, { useState } from 'react';
import {createData} from '../components/simpleTable'
...
export const ActionButton = (props) => {
  ...
  return (
    <div>
    <DialogForm actionTakenHandler={changeActionTaken} tableRows={props.tableRows} setTableRows={props.setTableRows} row={props.row}/>
  </div>
  )
}
